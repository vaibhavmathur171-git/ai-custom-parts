...
from templates import bottle_holder, bracket, hook, paper_towel_holder
...
for _spec_obj in (
    ...
    _spec(
        paper_towel_holder,
        paper_towel_holder.PaperTowelHolderParams,
        paper_towel_holder.make_paper_towel_holder,
    ),
):
